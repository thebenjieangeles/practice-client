...
function LoginForm({ user, setUser }) {
  ...
  return (
    <div className="min-h-screen ">
      <div className="flex flex-col h-screen items-center justify-center px-2 md:px-20 lg:px-40">
        ...
        <div className="flex flex-col items-center">
          <form
            ...
            className="border-solid border-2 border-black p-2 m-4 flex flex-col gap-2 max-w-md"
          >
